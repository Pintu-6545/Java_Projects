...
public class ProductDao {
	...
	public static void addProduct(Product p)
	{
		try {
			...
			String sql="insert into product (user_id,product_category,product_name,product_desc,product_price,product_image) values(?,?,?,?,?,?)";
	...
	// Product View Seller Site
	public static  List<Product> getProducts(int user_id)
	{
	...
	// Shop All Product View User Site
	...
	public static void updateProduct(Product p) {
        try {
            Connection conn = ElectroUtil.createConnection();
            String sql = "UPDATE product SET product_category=?, product_name=?, product_desc=?, product_price=?, product_image=? WHERE pid=?";
            PreparedStatement pst = conn.prepareStatement(sql);
