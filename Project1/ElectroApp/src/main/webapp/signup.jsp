                    ...
                    <b style="color:green;">
                     ...
                     %>
                        ...
                        <form name="frm" action="UserController" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                            <select class="form-select text-dark border-0 border-start rounded-1 p-3" name="usertype" style="width: 280px; ">
                            ...
                            <option value="Seller">Seller</option>
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="fname" id="name" placeholder="Your Name">
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="phone" class="form-control" name="mobile" id="phone" placeholder="Phone Mobile">
                                        <label for="phone">Your Mobile</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="password" id="project" placeholder="Password">
                                        <label for="project">Password</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="cpassword" id="project" placeholder=" Confirm Password">
                                        <label for="project">Confirm Password</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-floating">
                                        <input type="file" class="form-control" name="profile_picture" id="subject" placeholder="Picture">
                                ...
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Sign Up">Sign Up</button>
                                </div>
                            </div>
                        </form>
                    </div>
