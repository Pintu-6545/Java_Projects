                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                            <h4 class="text-primary border-bottom border-primary border-2 d-inline-block pb-2">Registration Form</h4>
                    ...
                    <b style="color:green;">
                     ...
                     %>
                        ...
                        <input type="hidden" name="user_id" value="<%= u.getUser_id() %>"> 
                            ...
                            <option value="---Select User Type---">---Select Product Category---</option>
                            ...
                            <option value="Watching Machine">Watching Machine</option>
                            <option value="Digital Light">Digital Light</option>
                        </select>
                        </div>
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="product_price" id="name" placeholder="Product Price">
                                ...
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Add Product">Add Product</button>
                                </div>
                            </div>
                        </form>
                    </div>
