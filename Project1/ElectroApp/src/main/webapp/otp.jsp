                            ...
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="otp" id="email" placeholder="Enter OTP">
                                        <label for="email">Enter OTP</label>
                                    </div>
                                </div>
                                
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Verify OTP">Verify OTP</button>
                                </div>
                            </div>
                        </form>
                    </div>
