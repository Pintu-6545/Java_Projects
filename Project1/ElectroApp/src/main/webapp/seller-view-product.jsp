                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                        	...
                        	<%
                        	     List<Product> list= ProductDao.getProducts(u.getUser_id());
                                  ...
                                  <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                      <div class="product-item-inner border rounded">
                                          <div class="product-item-inner-item">
                                              <img src="product_image/<%= p.getProduct_image() %>" class="img-fluid w-100 rounded-top" style="height:240px;"  alt="">
                                          ...
                                          <div class="text-center rounded-bottom p-4">
                                              ...
                                              <a href="#" class="d-block h4"><%= p.getProduct_name() %></a>
                                              <!--  del class="me-2 fs-5">₹90,000.00</del> -->
                                              <span class="text-primary fs-5"> ₹<%= p.getProduct_price() %></span>
                                                 
                                               <div class="my-3">
                                               		<a href="seller-product-detail.jsp?pid=<%= p.getPid() %>"
                                            class="btn btn-primary border-secondary rounded-pill py-2 px-6 mb-6" style="font-size:20px; font-weight: 600; margin:0 44px;">Product Details</a>
                                               </div>                                           
