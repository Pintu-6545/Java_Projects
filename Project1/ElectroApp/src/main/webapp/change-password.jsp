                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                            <h4 class="text-primary border-bottom border-primary border-2 d-inline-block pb-2">Password Change</h4>
                            ...
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="col-lg-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="old_password" id="project" placeholder="Old Password">
                                        <label for="project"> Old Password</label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="new_password" id="project" placeholder="New Password">
                                        <label for="project">New Password</label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="confirm_password" id="project" placeholder=" Confirm New Password">
                                        <label for="project">Confirm Password</label>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Change Password">Change Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
