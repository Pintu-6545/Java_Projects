                     ...
                     %>
                        ...
                        <form name="frm" action="UserController" method="post" enctype="multipart/form-data">
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Update Password">Update Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
