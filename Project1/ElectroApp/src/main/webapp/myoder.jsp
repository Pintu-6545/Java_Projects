                ...
                <table class="table">
                    ...
                    <tbody>
                           ...
                           <%
								...
								List<Cart> list=CartDao.getOder(u.getUser_id());
                                if(list.size()>0)
                                {
                                for(Cart c : list)
                                {
                            ...
                            <td>
                                <div class="input-group quantity py-4" style="width: 100px;">
                						<form method="post" action="change-qty.jsp" class="d-flex">
    										...
    										<!-- TEXTBOX -->
    						                   <input type="number" class="form-control form-control-sm text-center border-0" name="product_qty" value="<%= c.getProduct_qty() %>" min="1" max="10"  onchange="this.form.submit();" readonly="readonly">
