                        ...
                        <div class="row g-4">
                        	...
                        	%>	  
                                      ...
                                      <div class="product-item-inner border rounded">
                                          ...
                                          <div class="text-center rounded-bottom p-4">
                                              ...
                                              <span class="text-primary fs-5"> ₹<%= p.getProduct_price() %></span>
                                               ...
                                               <div class="my-3">
                                               		<a href="product-detail.jsp?pid=<%= p.getPid() %>"
                                            class="btn btn-primary border-secondary rounded-pill py-2 px-6 mb-6" style="font-size:20px; font-weight: 600;">Product Details</a>
                                               </div>                                           
                              ...
                              <%
                        	     ...
                        	     {
                        	%>
                        	   <h1 class="text text-primay">No Products In Wishlist</h1>
