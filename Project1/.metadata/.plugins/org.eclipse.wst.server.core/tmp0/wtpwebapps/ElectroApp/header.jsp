            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    <%
                       ...
                       {
                    %>
                    <a href="wishlist.jsp" class="text-muted d-flex align-items-center justify-content-center me-3 "><span
                            class="rounded-circle btn-md-square border"><i class=" far fa-heart"></i></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0">
                                    ...
                                    <a href="myoder.jsp" class="dropdown-item">MyOder</a>
                                    <a href="cheackout.jsp" class="dropdown-item">Cheackout</a>
                        ...
                        <%
                            ...
                            <%
                                ...
                                {
                               %>
                               <a href="signup.jsp" class="nav-item nav-link me-2">Sign Up</a>
                               <a href="login.jsp" class="nav-item nav-link me-2">Login</a>
                               <%
                                }
                                else
                                {
                                %>	
                                	<a href="logout.jsp" class="nav-item nav-link me-3">Logout(<%= u.getFname()  %>)</a>
                                 	 
                                 	 <div class="nav-item dropdown">
                                <a href="logout.jsp" class="nav-item nav-link me-5 " data-bs-toggle="dropdown"><img src="profile_picture/<%=u.getProfile_picture() %>" alt="Profile Picture"  style="width:60px; height:60px; border-radius: 50%; "></a>
                                <div class="dropdown-menu m-0">
