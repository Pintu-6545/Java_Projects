                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                            <h4 class="text-primary border-bottom border-primary border-2 d-inline-block pb-2">Update Profile Form</h4>
                    ...
                    <b style="color:green;">
                     ...
                     %>
                        ...
                        <form name="frm" action="UserController" method="post" enctype="multipart/form-data">
                        
                        <input type="hidden" class="form-control" value="<%= u.getUsertype() %>" name="usertype" id="usertype" >
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                    
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" value="<%= u.getFname() %>" name="fname" id="name" >
                                        <label for="name">First Name</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" value="<%= u.getLname() %>" name="lname" id="name" >
                                        <label for="name">Last Name</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" value="<%= u.getEmail() %>" name="email" id="email"  readonly="readonly">
                                        <label for="email"> Email</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="phone" class="form-control" value="<%= u.getMobile() %>" name="mobile" id="phone" >
                                        <label for="phone">Your Mobile</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                       <img src="profile_picture/<%=u.getProfile_picture() %>" alt="Profile Picture" style="width:100px; height:100px; border-radius: 50%;" >
                                    </div>
                                </div>
                                  <div class="col-6">
                                    <div class="form-floating">
                                        <input type="file" class="form-control" name="profile_picture" id="subject" >
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" name="address"  id="message"
                                            style="height: 120px"><%=u.getAddress() %></textarea>
                                        <label for="address">Address</label>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="Update Profile">Update Profile</button>
                                </div>
                            </div>
                        </form>
                    </div>
