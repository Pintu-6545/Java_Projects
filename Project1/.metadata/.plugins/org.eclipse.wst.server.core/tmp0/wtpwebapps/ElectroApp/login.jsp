                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                            <h4 class="text-primary border-bottom border-primary border-2 d-inline-block pb-2">Login Form</h4>
                     ...
                     %>
                        ...
                        <form name="frm" action="UserController" method="post" enctype="multipart/form-data">
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" style="font-size: 25px; font-family: sans-serif; font-weight: 600" name="action" value="login">Login</button><br>
                                    <br>
