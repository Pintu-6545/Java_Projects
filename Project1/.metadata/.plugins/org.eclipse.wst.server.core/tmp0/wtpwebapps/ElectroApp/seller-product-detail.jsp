                    ...
                    <div class="row g-4 single-product">
                        ...
                        <div class="col-xl-7">
                            ...
                            <a href="seller-product-edit.jsp?pid=<%=p.getPid() %>"
                                class="btn btn-primary  fw-bolder border-secondary rounded-pill px-4 py-2 mb-4 text-light"><i
                                    class="fas fa-edit me-2 text-white"></i>Edit</a>
                             <a href="seller-product-delete.jsp?pid=<%=p.getPid() %>"
                                class="btn btn-primary fw-bolder border-secondary bg-danger rounded-pill px-4 py-2 mb-4 text-primary"><i
                                   class="fa fa-trash me-2 text-white" aria-hidden="true"></i>Delete</a>
                             </div>
