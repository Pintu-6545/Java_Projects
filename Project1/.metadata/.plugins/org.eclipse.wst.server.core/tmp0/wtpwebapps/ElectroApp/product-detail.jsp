                ...
                <div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                   ...
                   %>
                    <div class="row g-4 single-product">
                        <div class="col-xl-5">
                            <div class="single-carousel owl-carousel">
                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='product_image/<%= p.getProduct_image() %>'   alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="product_image/<%= p.getProduct_image() %>" style="max-height:700px;" class="img-fluid rounded" alt="Image">
                                    </div>
                                </div>
                                <!--  <div class="single-item"
                        ...
                        <div class="col-xl-7">
                            <h3 class="fw-bold mb-3"><%=p.getProduct_name() %></h3>
                            ...
                            %>
                             ...
                             <a href="add-to-cart.jsp?pid=<%=p.getPid() %>&user_id=<%= u.getUser_id() %>"
                                class="btn btn-primary fw-bolder border-secondary bg-danger rounded-pill px-4 py-2 mb-4 text-primary"><i
                                   class="fas fa-shopping-cart me-2" aria-hidden="true"></i> Add To Cart</a>
                             </div>
                             <%
                            		}
                            		...
                            		{
                             %>
                                  <a href="remove-from-cart.jsp?pid=<%=p.getPid() %>&user_id=<%= u.getUser_id() %>"
                                class="btn btn-danger fw-bolder border-secondary bg-danger rounded-pill px-4 py-2 mb-4 text-light"><i
                                   class="fas fa-shopping-cart me-2" aria-hidden="true"></i> Remove From Cart</a>
                            ...
                            %>
                             ...
                             <a href="add-to-wishlist.jsp?pid=<%=p.getPid() %>&user_id=<%= u.getUser_id() %>"
                                class="btn btn-primary fw-bolder border-secondary bg-danger rounded-pill px-4 py-2 mb-4 text-primary"><i
                                   class="fas fa-heart" aria-hidden="true"></i> Add To Wishlist</a>
                             </div>
                             <%
                            		}
                            		...
                            		{
                             %>
                                  <a href="remove-from-wishlist.jsp?pid=<%=p.getPid() %>&user_id=<%= u.getUser_id() %>"
                                class="btn btn-danger fw-bolder border-secondary bg-danger rounded-pill px-4 py-2 mb-4 text-light" style="hight:50px;"><i
                                   class="fa fa-trash me-2 text-white" aria-hidden="true"></i> Remove From Wishlist</a>
                             ...
                             %>
                            <p class="mb-3 h6 text-danger"><%=p.getProduct_desc() %></p>
                            <h5 class="fw-bold mb-3">₹<%= p.getProduct_price() %></h5>
                            <div class="mb-3">
                ...
                <div class="related-item rounded">
                    <div class="related-item-inner border rounded">
                        <div class="related-item-inner-item">
                            <img src="product_image/<%=p1.getProduct_image() %>"style="height:200px;" class="img-fluid w-100 rounded-top" alt="">
                        ...
                        <div class="text-center rounded-bottom p-4">
                            <a href="#" class="d-block h4"><%=p1.getProduct_name() %></a>
                            <span class="text-primary fs-5" style="font-weight:600">₹ <%=p1.getProduct_price() %></span>
                        </div>
                    </div>
                    <div class="related-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex">
								<a href="product-detail.jsp?pid=<%= p1.getPid() %>" style="font-weight:600" class="btn btn-primary border-secondary rounded-pill py-2 px-4 mb-2">Product Details</a>
                            </div>
                            <div class="d-flex">
                                <a href="#"
